...
export default function About() {
  return (
    <div className="flex flex-col bg-studio-magenta min-h-screen">
      {/* Narrative Section */}
      <section className="py-20 pt-32 mb-0">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="font-serif text-5xl md:text-8xl font-bold mb-8 italic leading-tight text-white">
                Crafting Excellence <br /> in the Heart of <span className="text-studio-gold">Delhi.</span>
              </h1>
              <p className="text-2xl text-studio-white/80 font-bold leading-relaxed mb-0 italic">
      ...
      {/* Leadership Section */}
      <section className="py-20 overflow-hidden mb-0">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center mb-16">
             <span className="text-studio-gold text-sm font-bold uppercase tracking-widest mb-4">Leadership</span>
             <h2 className="font-serif text-4xl md:text-6xl font-bold text-white">The Minds Behind the Studio</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-5xl mx-auto">
            {TEAM.map((member, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="group p-8 bg-black/20 rounded-[40px] border border-white/5 hover:border-studio-gold/20 transition-all"
              >
                <div className="flex flex-col gap-8 items-center text-center">
                  ...
                  <div>
                    <h3 className="text-3xl font-serif font-bold mb-2 text-white">{member.name}</h3>
      ...
      <section className="py-20 bg-black/10">
        <div className="container mx-auto px-6">
          <div className="p-12 md:p-20 border border-white/10 rounded-[60px] text-center max-w-5xl mx-auto relative overflow-hidden flex flex-col items-center">
             ...
             <h2 className="font-serif text-3xl md:text-5xl font-bold mb-8 text-white">Want to build the future with us?</h2>
